...
## 1a) What is the estimated population size of Peromyscus mice inside and outside the burn area (this is done in the code cell below for you)? (Use a simple closed population function in the R package `Rcapture`).
```{r}
...
SE_M0 <- PMPop.unburned$results["M0", "stderr"]


# Display the results for both models
cat("\nConstant capture probability model (M0):\n")
